...
function validate_done () {
  if ((validate3 && validate4).value === "") { 
           validate3.placeholder = "atleast enter 1 char";
           validate4.placeholder = "atleast enter 1 char";
...
function reverse_geocoder() {
  ...
  geocoder.geocode({'address': any_address.value}, function(results, status) {
    if (status === google.maps.GeocoderStatus.OK) {
       if (parser) {
        window.location.assign("map_results.html")
        autorized.classList.remove("none");
   ...
   function authorize_me (event) {
   	   if ((validate1.value == "") && (validate2.value == "")) { 
   	   	   validate1.placeholder = "atleast enter 1 char";
           validate2.placeholder = "atleast enter 1 char";
